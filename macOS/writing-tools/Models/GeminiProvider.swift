...
enum GeminiModel: String, CaseIterable {
    ...
    case twoflashlite = "gemini-2.0-flash-lite-preview-02-05"
    ...
    var displayName: String {
        ...
        case .twoflashlite: return "Gemini 2.0 Flash Lite (intelligent | very fast | 30 uses/min)"
...
class GeminiProvider: ObservableObject, AIProvider {
    ...
    func processText(systemPrompt: String? = "You are a helpful writing assistant.",
        ...
        if let content = candidates.first?["content"] as? [String: Any],
           ...
           let text = partsArray.first?["text"] as? String {
            return text
        }
